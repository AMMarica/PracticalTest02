...
public class ServerThread extends Thread {
    ...
    private HashMap<String, CurrentPriceInformation> data = null;
...
//    public synchronized void setData(String city, CurrentPriceInformation currentPriceInformation) {
//        this.data.put(city, currentPriceInformation);
//    }
//
